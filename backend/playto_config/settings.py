"""
Django settings for playto_config project.
...
if os.getenv('DATABASE_URL'):
    try:
        ...
        print(f"Warning: Failed to configure Supabase: {e}. Falling back to SQLite.")
        DATABASES['default'] = {
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'api.auth.ClerkJWTAuthentication',
    ],
...
CLERK_JWT_ISSUER = os.getenv('CLERK_JWT_ISSUER', 'https://epic-marlin-86.clerk.accounts.dev')
CLERK_JWT_KEY = os.getenv('CLERK_JWT_KEY', 'https://epic-marlin-86.clerk.accounts.dev/.well-known/jwks.json')
